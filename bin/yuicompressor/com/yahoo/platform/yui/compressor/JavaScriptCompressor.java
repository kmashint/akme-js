...
public class JavaScriptCompressor {
    ...
    */
    ...
    public void compress(Writer out, int linebreak, boolean munge, boolean verbose,
            boolean preserveAllSemiColons, boolean disableOptimizations, boolean keepHints)
            throws IOException {

        this.munge = munge;
        this.verbose = verbose;
        this.keepHints = keepHints;
            ...
            switch (token.getType()) {
                ...
                case Token.FUNCTION:
                    ...
                    if (token.getType() == Token.STRING &&
                        ...
                        consumeToken();
                        consumeToken();
                        if (keepHints) result.append(token.getValue()).append(';');
                    }
                    break;
