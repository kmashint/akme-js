...
public class YUICompressor {
    ...
    public static void main(String args[]) {
        ...
        CmdLineParser.Option keepHintsOpt = parser.addBooleanOption("keep-hints");
        ...
        try {
            ...
            boolean keepHints = parser.getOptionValue(keepHintsOpt) != null;
                    ...
                    if (type.equalsIgnoreCase("js")) {
                        ...
                        try {
                            ...
                            compressor.compress(out, linebreakpos, munge, verbose,
                                    preserveAllSemiColons, disableOptimizations, keepHints);
    ...
    private static void usage() {
        System.err.println(
                "YUICompressor Version: @VERSION@\n"
                        ...
                        + "  --keep-hints              Keep hints in output to pass through 'use strict';\n\n"
